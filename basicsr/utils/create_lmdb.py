...
def create_lmdb_for_LG():
    folder_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/train/input_crops'
    lmdb_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/train/input_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'PNG')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/train/gt_crops'
    lmdb_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/train/gt_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'PNG')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # for val
    folder_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/val/input_crops'
    lmdb_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/val/input_crops.lmdb'
    mat_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/ValidationNoisyBlocksSrgb.mat'
    if not osp.exists(folder_path):
        os.makedirs(folder_path)
    assert osp.exists(mat_path)
    data = scio.loadmat(mat_path)['ValidationNoisyBlocksSrgb']
    ...
    folder_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/val/gt_crops'
    lmdb_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/val/gt_crops.lmdb'
    mat_path = '/home/ubuntu/whyeo/DACON/LG_Camera/HINet/datasets/LG/ValidationGtBlocksSrgb.mat'
    if not osp.exists(folder_path):
        os.makedirs(folder_path)
    assert osp.exists(mat_path)
    data = scio.loadmat(mat_path)['ValidationGtBlocksSrgb']
